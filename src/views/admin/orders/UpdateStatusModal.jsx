  ...
  const getValidNextStatuses = () => {
    switch (order.status) {
      case ORDER_STATUS.PENDING:
        return [ORDER_STATUS.PROCESSING, ORDER_STATUS.COMPLETED, ORDER_STATUS.CANCELLED];
      case ORDER_STATUS.PROCESSING:
        return [ORDER_STATUS.PENDING, ORDER_STATUS.COMPLETED, ORDER_STATUS.CANCELLED];
      case ORDER_STATUS.COMPLETED:
        return [ORDER_STATUS.PENDING, ORDER_STATUS.PROCESSING, ORDER_STATUS.CANCELLED];
      case ORDER_STATUS.CANCELLED:
        return [ORDER_STATUS.PENDING, ORDER_STATUS.PROCESSING, ORDER_STATUS.COMPLETED];
      default:
